// lib/screens/user/home/home_tab.dart - FIXED VERSION
...
class _HomeTabState extends State<HomeTab> with TickerProviderStateMixin {
  ...
  // FIXED: Check for active orders excluding terminated orders
  Future<void> _checkActiveOrder() async {
    try {
      final user = FirebaseAuth.instance.currentUser;
      if (user == null) return;
      
      // FIXED: Exclude 'Terminated' from active order check
  ...
  void _showStockError() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('This item is out of stock or not available'),
