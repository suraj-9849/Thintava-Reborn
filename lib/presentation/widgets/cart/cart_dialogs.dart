// lib/presentation/widgets/cart/cart_dialogs.dart - FIXED OVERFLOW VERSION
...
class CartDialogs {
  /// Enhanced Payment Success Dialog - FIXED OVERFLOW
  static void showPaymentSuccessDialog(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Container(
          // ✅ FIX: Use constrained container with scrollable content
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Enhanced order summary - CONDENSED
                Container(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              "Payment processed successfully. Kitchen has been notified.",
                              style: GoogleFonts.poppins(
                                fontSize: 11, // Reduced size
                                color: Colors.green.shade600,
                                height: 1.3,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              "Track your order status in real-time and get notified when it's ready.",
                              style: GoogleFonts.poppins(
                                fontSize: 11, // Reduced size
        ...
        actions: [
          // ✅ FIX: Single action button with proper padding
          Container(
